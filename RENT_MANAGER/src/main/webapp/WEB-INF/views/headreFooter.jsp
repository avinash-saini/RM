...
<!-- <div class="">
    ...
    <div class="row">
        ...
        <div class="bottom-align-text col-sm-12">
            <footer>
                <p>&copy; Copyright 2018 Rant Manager</p>
            </footer>
        </div>
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <li class="dropdown" ><a class="dropdown" data-toggle="dropdown" href="#" role="menu"  aria-haspopup="true" aria-expanded=""  >RANTER <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="AddRenter">ADD NEW RENTER </a></li>
          <li><a href="#">UPDATE RANTER</a></li>
          <li><a href="#">VIEW RANTER</a></li>
        <li><a href="RenterList">RANTER LIST</a></li>
